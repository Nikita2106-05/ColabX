        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-blue-600 rounded-[3rem] p-12 md:p-24 text-center text-white shadow-2xl shadow-blue-300 relative overflow-hidden">
            <div className="relative z-10">
              ...
              <button className="bg-white text-blue-600 px-12 py-5 rounded-2xl font-black text-xl hover:bg-slate-50 hover:scale-105 transition-all">
                Create Profile Now
              </button>
            </div>
            {/* Design patterns */}
