...
import { Link } from 'react-router-dom'; // Link ka upyog navigation ke liye karenge
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link 
              to="/login" 
              className="hidden sm:block text-slate-600 font-bold hover:text-blue-600 px-4"
            >
              Login
            </Link>
            ...
            <Link 
              to="/register" 
              className="bg-blue-600 text-white px-6 py-2.5 rounded-full font-bold shadow-lg shadow-blue-200 hover:bg-blue-700 hover:scale-105 transition-all"
            >
              Register
            </Link>
          </div>
